...
from app.services.retrieval import embed_texts, get_embedding_dim
from app.ingestion.loader import parse_pdf
...
if __name__ == "__main__":
    ...
    #   python -m app.ingestion.preprocessor data general
